        ...
        <section className="text-gray-600 body-font">
            <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
                ...
                <div className="text-center lg:w-2/3 w-full">
                    <h1 className="title-font underline underline-offset-8 sm:text-4xl font-bold text-3xl mb-4 font-medium text-gray-900 mb-9">
                        Result
                    </h1>
                    <h1 className="title-font sm:text-2xl text-2xl mb-4 font-bold text-gray-900">
                       <p className="font-medium text-xl">{result >= 70 ? "Congratulations" : result >= 40 ? "Good" : "Fail"}</p> 
                        Mark is 100 / {result}
                    </h1>
